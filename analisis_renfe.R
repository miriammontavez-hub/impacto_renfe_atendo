...
listado_de_estaciones_ave_ld_md <- read_delim("Cosas de estudiar/Cursos/Programación/Coursera/Google Data Analyst/Proyecto final/datos/csv/listado_completo_av_ld_md.csv", delim = ";", trim_ws = TRUE, locale = locale(decimal_mark = ","), col_types = cols(`CÓDIGO` = col_integer())) %>%
  clean_names()
